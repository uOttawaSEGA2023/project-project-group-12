...
public class PatientAppointmentAdapter extends RecyclerView.Adapter<PatientAppointmentAdapter.AppointmentViewHolder> {
    ...
    public PatientAppointmentAdapter(List<Appointment> list, OnItemClickListener listener) {
        this.list = list;
    ...
    class AppointmentViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final Appointment appointment, final OnItemClickListener listener) {
            getUserFromDatabase(appointment.getDoctorUUID(), new UserCallback() {
                @Override
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (listener != null) {
                        listener.onItemClick(appointment, doctor);
                    }
                }
            });
        }
